...
API_VER = "v26.0"
TEST_VERSION = "v26.5.2"
BUILD_ID = "2026-08-12-meta-generated-thumbnail-r2"
...
REPORT_FILE = "duplicate_test_v26_5_2_meta_generated_thumbnail_report.json"
...
def run():
    ...
    suffix = f" [PYTEST-V26.5.2 {datetime.now(POLAND_TZ).strftime('%Y%m%d-%H%M%S')}]"
    ...
    result = {
        ...
        "thumbnail_strategy": "META_GENERATED_FRAME",
        "ads_manager_thumbnail_label_expected": "VERIFY_EMPIRICALLY",
...
def summary(result):
    lines = [
        "🧪 <b>Duplicate test v26.5.2 • TRUE ADSET + AD DUPLICATE</b>",
        ...
        "Ads Manager Auto/Manual label: <b>VERIFY ON SCREEN</b>",
        ...
        "",
        f"True duplicate v26.5.2: {'✅ PASS' if result['true_duplicate_ok'] else '❌ FAIL'}",
        f"Publish probe v26.5.2: {'✅ PASS' if result['publish_probe_ok'] else '❌ FAIL'}",
    ]
...
def error_message(exc):
    ...
    return (
        "❌ <b>Duplicate test v26.5.2 error</b>\n"
        f"Build: <code>{esc(BUILD_ID)}</code>\n"
